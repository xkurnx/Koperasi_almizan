...
class example_dropbox extends CI_Controller
{
	...
	{
		$params['key'] = 'j8tjbnj1av6jvrs';
		$params['secret'] = 'u221euval55q2rr';
			
		$this->load->library('dropbox', $params);
		$data = $this->dropbox->get_request_token(site_url("example_dropbox/access_dropbox"));
	...
	public function access_dropbox()
	{
        ...
        redirect('example_dropbox/test_dropbox');
	}
	...
	public function upload_dropbox()
	{
       ...
       # $dbobj = $this->dropbox->add($dbpath, $filepath,$params, $root='dropbox');
		$dbobj = $this->dropbox->create_folder("test_create_by_CI", $root='dropbox');
		#$dbobj = $this->dropbox->account();
		#echo getcwd() . "\n";
